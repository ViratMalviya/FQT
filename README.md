...
| 📉 **99.85% Parameter Reduction** | 34 VQC params generate 23,184 conv weights — massive efficiency gain for edge deployment |
...
- Only **34 VQC rotation angles** (2 layers × 17 qubits) and the MLP mapping head weights are transmitted per round
